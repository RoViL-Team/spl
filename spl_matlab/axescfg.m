function axescfg(a,ag,ar,av,kv,gr,lv)
...
%
%   lv is whether to visualize the patches in 2D local xy-frame view, default 0
%
% Copyright (C) 2013 Marsette A. Vona, Dimitrios Kanoulas

if (nargin<7); lv = 0; end
...
if (~kv)
  if (~lv); view(a,3); end % set default 3d viewpoint
