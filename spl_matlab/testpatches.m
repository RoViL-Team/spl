...
defppo = {'aw',3,'as',1.5,'bw',2,'gw',0.5,'gr',0, 'bw',2, 'aw',3, 'as', 1, ...
          'fa', 0.9};
...
p(i).s = 'p'; p(i).b = 'e'; p(i).d = [2.5 1.7]; p(i).ss = dss;
p(i).gd = 2;

i=i+1;
p(i).name = 'plane (aa rect)';
p(i).s = 'p'; p(i).b = 'r'; p(i).d = [2.5 2]; p(i).ss = 2*dss;
