...
%
%   Option 'minar' (default 0): if positive, iterations terminate whenever the
%   residual is less than minar.
%
...
%
%   Option 'minada' (default 0): if positive, iterations terminate whenever the
%   magnitude of the parameter differential da is less than minada.
%
...
%
%   Option 'nda' (default []): parameter stepsize for numeric derivatives, see 
%   numj() for details.
%
