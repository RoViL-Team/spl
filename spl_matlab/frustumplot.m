...
%   new figure window is opened.  The return value h is the handle of a new 
%   Matlab hgtransform group containing the generated graphics.
%
...
%
%   Option 'uc' (default 'm'): frustum line color, either a scalar color name or
%   [r g b].
%
